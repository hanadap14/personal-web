            ...
            <div class="card-body">
                <form action="{{ url('admin/portfolio/'.$port->id) }}" method="post">
                    ...
                    <div class="mb-2">
                        ...
                        <input type="text" name="title" id="title" class="form-control" required value="{{ $port->title }}">
                    </div>
                    <div class="mb-2">
                        <label for="year">Year</label>
                        <input type="number" name="year" id="year" class="form-control" required value="{{ $port->year }}">
                    </div>
